                        ...
                        <DialogContent className="!gap-0">
                            ...
                            <div className="mt-4 flex flex-row items-center gap-4">
                                <div className="shrink-0 rounded-md border p-2  border-[#0009321f] dark:border-gray-600 bg-white">
                                    {isLoading || !mfaData?.qrImageUrl ? <Skeleton className="w-[160px] h-[160px]" /> : (
                                        <img
                                            alt="QR code"
                                ...
                                text-sm text-[#0007149f] dark:text-muted-foreground font-normal"
                                        >
                                            ...
                                            <button onClick={() => onCopy(mfaData?.secret)} disabled={copied}>
                                                {copied ? (
                            ...
                            <div className="mt-8 border-t">
                                <Form {...form}>
                                    ...
                                    >
                                        ...
                                        />
                                        <Button className="w-full h-[40px]" type="submit" disabled={isPending}>
